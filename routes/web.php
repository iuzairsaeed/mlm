...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('userfacebook', 'BonusController@user_facebook')->name('userfacebook');
        ...
        Route::get('plan/bonus', 'BonusController@index')->name('plan.bonus');
        Route::post('plan/bulkbonus', 'BonusController@bulkbonus')->name('plan.bulkbonus');
        ...
        Route::name('frontend.')->prefix('frontend')->group(function () {
            ...
            Route::get('/create-webinar', 'FrontendController@create_webinar')->name('/create-webinar');
            Route::post('/store-webinar', 'FrontendController@store')->name('/store-webinar');
            Route::get('/edit/{id}', 'FrontendController@edit')->name('/edit/{id}');
            Route::post('/update/{id}', 'FrontendController@update')->name('/update/{id}');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('webinar', 'UserController@webinar')->name('webinar');
            Route::get('plan/testing', 'PlanController@testing')->name('plan.testing');
       
            Route::get('my_all_webinar', 'UserController@my_all_webinar')->name('my_all_webinar');
            Route::get('detail/{id}', 'UserController@webinar_detail')->name('detail/{id}');
            Route::get('create_webinar', 'UserController@create_webinar')->name('create_webinar');
            Route::post('webinar_store', 'UserController@webinar_store')->name('webinar_store');
            Route::post('webinar_update/{id}', 'UserController@webinar_update')->name('webinar_update/{id}');
...
Route::post('/pin/assign_pin/{id}', 'EpinController@assign_pin')->name('/pin/assign_pin/{id}');
