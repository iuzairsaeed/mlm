...
class FrontendController extends Controller
{
    ...
    public function webinar(){
        ...
        $all_wbinars = Webinar::paginate(12);
        $emptyMessage = "No data found.";
        return view('admin.frontend.webinar.index',get_defined_vars());
    }

    public function create_webinar(){
        $pageTitle = "Create Webinars";
        return view('admin.frontend.webinar.create',get_defined_vars());
    }
    ...
    public function store(Request $request){
        ...
        $webinar = new Webinar;
        $webinar->user_id = Auth::guard('admin')->user()->id;
        ...
        $webinar->created_by = 'admin';
        $webinar->save();
        $notify[] = ['success', 'Webinar has been created.'];
        return redirect('/admin/frontend/webinar')->withNotify($notify);
    }


    public function edit($id){
        $pageTitle = "Webinar Details";
        $webinar_details = Webinar::where('id',$id)->first();
        return view('admin.frontend.webinar.edit',get_defined_vars());
    }
