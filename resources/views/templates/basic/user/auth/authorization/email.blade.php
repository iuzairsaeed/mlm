...
<section class="account-section">
    <div class="left" style="background-image: url('{{ getImage('assets/images/frontend/auth/'.getContent('auth.content',true)->data_values->image) }}');">
        <div class="left-inner text-center">
            <h3 class="title text-white mt-2">@lang('Verify Your Email to Get Access')</h3>
        </div>
    </div>
    ...
    <div class="right">
        ...
        <div class="middle w-100">
            <form action="{{route('user.verify.email')}}" method="POST" class="contact-form row mb--25 align-items-center">
            @csrf
                <div class="col-md-12">
                    <div class="contact-form-group">
                        <label for="username">@lang('Verification Code')</label>
                        <input type="text" name="email_verified_code" maxlength="7" id="code"  placeholder="@lang('Enter Verification Code')" required="">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="contact-form-group">
                        <p class="text-white m-0">@lang("Please check including your Junk/Spam Folder. if not found, you can") <a href="{{route('user.send.verify.code')}}?type=email"
                                class="text-theme forget-pass">@lang('Resend code')</a>
                        </p>
                    </div>
                </div>
            </form>
