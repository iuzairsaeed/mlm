    ...
    <div class="col-lg-12">
                <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
                    <div class="card mt-50">
                        <div class="card-body">
                            <h5 class="card-title border-bottom pb-2">Information of {{$webinar_details->webinar_title}}</h5>

                            <form action="/admin/frontend/update/{{$webinar_details->id}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            ...
                                            <input class="form-control" required type="text" value="{{$webinar_details->webinar_title}}" name="webinar_title" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" required name="webinar_descripion">
                                                {{$webinar_details->webinar_descripion}}
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="form-control-label font-weight-bold">Webinar Link <span
                                                    class="text-danger">*</span></label>
                                            <input class="form-control" type="text" value="{{$webinar_details->webinar_link}}" name="webinar_link" required>
                                        </div>
                                    </div>
