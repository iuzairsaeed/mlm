                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label class="form-control-label font-weight-bold">@lang('E-pin Charge')</label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disabled')" name="epin_status" @if($general->epin_status) checked @endif>
                            </div>

                            <div class="form-group col-md-3">
                                <label class="form-control-label font-weight-bold">@lang('Balance Transfer')</label>
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disabled')" name="balance_transfer" @if($general->balance_transfer) checked @endif>
                            </div>
                        </div>

                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="price" class="form-control-label font-weight-bold">@lang('E-Pin Generate Charge')</label>
                                <div class="input-group mb-3">
                                      <input type="text" id="price" class="form-control form-control-lg" value="{{getAmount($general->epin_charge)}}"  name="epin_charge" aria-label="Recipient's username" aria-describedby="basic-addon2" required="">
                            ...
                            <div class="form-group col-md-4">
                                <label for="price" class="form-control-label font-weight-bold">@lang('Balance Transfer Percent Charge')</label>
                                <div class="input-group mb-3">
                                      <input type="text" id="price" class="form-control form-control-lg" value="{{getAmount($general->balance_transfer_percent_charge)}}"  name="balance_transfer_percent_charge" aria-label="Recipient's username" aria-describedby="basic-addon2" required="">
                                      <div class="input-group-append">
                                        <span class="input-group-text" id="basic-addon2">%</span>
                                      </div>
                                </div>
                            ...
                            <div class="form-group col-md-4">
                                <label for="price" class="form-control-label font-weight-bold">@lang('Balance Transfer Fixed Charge ')</label>
                                <div class="input-group mb-3">
                                      <input type="text" id="price" class="form-control form-control-lg" value="{{getAmount($general->balance_transfer_fixed_charge)}}" name="balance_transfer_fixed_charge" aria-label="Recipient's username" aria-describedby="basic-addon2" required="">
                                      <div class="input-group-append">
