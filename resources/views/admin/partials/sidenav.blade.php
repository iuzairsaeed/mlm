    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.userfacebook')}}">
                    <a href="{{route('admin.userfacebook')}}" class="nav-link ">
                        <i class="menu-icon las la-home"></i>
                        <span class="menu-title">@lang('User Facebook')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.plan*',2)}} ">
                        ...
                        <li class="sidebar-menu-item {{menuActive(['admin.plan.index', 'admin.plan.bonus','admin.plan.edit', 'admin.plan.subscribers'])}} ">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.frontend.sections*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item">
                                <a href="/admin/frontend/webinar" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Live Webinar')</span>
                                </a>
                            </li>
                            @php
